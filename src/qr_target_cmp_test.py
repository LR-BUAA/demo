...
class Cfg:
    use_qrcode = True
    target_source_topic = "<topic_name>"
...
class Cyka:
    ...
    def __init__(self):
        ...
        rospy.Subscriber("/d400/color/image_raw/compressed", CompressedImage, self.img_cb, queue_size=10)
        self.at_detector = apriltag.Detector(apriltag.DetectorOptions(families='tag16h5'))

        self.cvb = cv_bridge.CvBridge()
        self.xywh_pub = rospy.Publisher("/target_xywh", Quaternion, queue_size=1)
